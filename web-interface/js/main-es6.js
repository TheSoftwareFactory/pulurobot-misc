...
// var socket_di = createWebSocket(get_appropriate_ws_url(), "rn1-protocol")
                    ...
                    case RECEPTION_CODE.CURRENT_POSITION:
                        {
                            robotMap.setRobotPosition(
                              (new DataView(arrayBuffer.slice(3, 5)).getInt16(0, false)) / 65536 * 2 * Math.PI
                              (new DataView(arrayBuffer.slice(5, 9)).getInt32(0, false))
